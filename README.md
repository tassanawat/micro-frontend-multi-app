...
1. Clone the starterkit for this tutorial:
  Ref:  https://github.com/harshal77/micro-frontend-multi-framework --branch development
...
3. Start the container (Port 4200) app first then other micro fronends like angular-mfe (Port 4201), profile-mfe (4203), react-mfe (Port 4204).
...
5.2) Switch into the ``Container or Shell`` app and open the file ``routing file``
...
1. Start the ``egp-seed-shell-mfe-web``,  ``angular-mfe`` and ``react-mfe`` side by side:
